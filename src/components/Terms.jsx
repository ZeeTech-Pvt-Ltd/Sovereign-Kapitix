...
// rewritten for Sovereign Kapitix in its own words. Brand colors/fonts unchanged.
const sections = [
  {
    n: '01',
    t: 'Acceptance of Terms',
    p: [
      "These Terms of Use (\"Terms\") govern your access to and use of the Sovereign Kapitix website and platform (the \"Service\"). By creating an account or otherwise using the Service, you confirm that you have read, understood, and agree to be bound by these Terms, together with our Privacy Policy and Risk Disclosure.",
  ...
  },
  {
    ...
    p: [
      'Sovereign Kapitix provides technology and information tools, including AI-assisted market analysis, trading signals, and related content. The Service is provided for informational purposes only.',
      'Sovereign Kapitix is not a licensed financial adviser, broker, or investment manager. Nothing on the Service constitutes personalised investment advice, a recommendation, an offer, or a solicitation to buy or sell any asset. Any decision you make - and its outcome - remains your responsibility.',
    ],
  },
  {
    n: '04',
  ...
  },
  {
    ...
    t: 'Fees',
    p: [
      'Where applicable, fees are disclosed before you commit to any action. By proceeding, you authorise the deduction of such fees. We may adjust fees from time to time, with notice where required by law. Sovereign Kapitix does not charge registration or subscription fees.',
    ],
  },
  {
    n: '07',
  ...
  },
  {
    ...
    p: [
      'The Service and all content, software, and materials made available through it are owned by or licensed to Sovereign Kapitix and are protected by intellectual property laws. You may not copy, modify, distribute, or create derivative works from any part of the Service without our prior written consent.',
    ],
  },
  {
    n: '09',
  ...
  },
  {
    ...
    p: [
      'To the maximum extent permitted by law, Sovereign Kapitix, its affiliates, officers, and employees shall not be liable for any indirect, incidental, special, or consequential damages, or for any loss of profits, data, or goodwill, arising out of or in connection with your use of the Service.',
    ],
  },
  {
    n: '12',
    ...
    <>
      ...
      <section className="terms-hero">
        <div className="container terms-hero-inner reveal">
          ...
          <p className="lead">The rules that govern your use of the Sovereign Kapitix platform.</p>
