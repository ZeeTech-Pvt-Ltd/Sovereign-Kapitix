...
// is rewritten for Sovereign Kapitix in its own words. Brand colors/fonts unchanged.
...
const sections = [
  {
    ...
    t: 'Introduction',
    p: [
      "Sovereign Kapitix (\"we\", \"us\", \"our\") respects your privacy and treats personal information with transparency and integrity. This Privacy Notice explains what information we collect, how we use it, and the choices you have.",
    ],
  },
  {
    n: '02',
    ...
    <>
      ...
      <section className="terms-hero">
        <div className="container terms-hero-inner reveal">
          ...
          <p className="lead">How Sovereign Kapitix collects, uses, and protects your personal information.</p>
