...
const sections = [
  ...
  },
  {
    ...
    p: [
      'Sovereign Kapitix provides technology and information tools. Nothing on the platform - including AI-generated analysis, signals, or other content - constitutes personalised investment advice, a recommendation, or a solicitation to trade. All content is provided for informational purposes only.',
    ],
  },
  {
    n: '04',
    ...
    <>
      ...
      <section className="terms-hero">
        <div className="container terms-hero-inner reveal">
          ...
          <p className="lead">
            The risks you should understand before using the Sovereign Kapitix platform. If you are new to
            Sovereign Kapitix, read this page in full before you deposit any funds.
          </p>
